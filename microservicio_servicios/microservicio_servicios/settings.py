"""
Django settings for microservicio_servicios project.
...
ROOT_URLCONF = 'microservicio_servicios.urls'
...
WSGI_APPLICATION = 'microservicio_servicios.wsgi.application'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'utils.middleware.MicroserviceJWTAuthentication',  # Tu clase personalizada
